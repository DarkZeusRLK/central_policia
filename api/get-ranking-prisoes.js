export default async function handler(req, res) {
  ...
  try {
    // Busca o canal de ranking de prisões (ajuste o ID do canal conforme necessário)
    ...
    // O bot deve ter um sistema que armazena as prisões e retorna um ranking
    ...
    console.error("Erro API Ranking Prisões:", error);
    return res.status(500).json({
      error: "Erro interno",
      ranking: [],
    });
